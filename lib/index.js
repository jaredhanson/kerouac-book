...
exports = module.exports = function(title, dir, options) {
  ...
  site.page('/index.html', require('./handlers/chapter')(title, dir, readmeFile, options.layout));
  site.page('/*.html', require('./handlers/chapter')(title, dir, false, options.layout));
